...
- acs maintains the `quality/` and `operations/` doc sets for consumers (test strategy + release/ops runbooks), produced by `/create-architecture` from templates. *(Proposed — see [ADR 0011](../adr/0011-sdlc-doc-sets-quality-and-operations.md).)*
