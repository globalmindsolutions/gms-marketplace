...
|-------|------------|-----|
| acs Skills (16) | Markdown SKILL.md, Claude Code plugin skill format | acs coordinator protocols; user-invocable as `/acs:<name>` (16 skills; tabp has 2 skills — screen-cvs and usage — via Cowork, counted separately) |
